...
with st.sidebar:
    ...
    st.markdown("- 🧪 مختبر المحاكاة (7 محاكيات معمارية وتصدير CAD)")
    st.markdown("- 🗺️ خارطة GIS التفاعلية لمحافظات العراق الـ 18")
    st.markdown("- 🤖 المدقق الذكي للمخططات الهندسية (AI Plan Checker)")
    st.markdown("- 👁️ محاكي التجربة الحسية والتعايش (Empathy Mode)")
    st.markdown("- 👥 منظومة صوت المواطن والتبليغ عن العوائق")
    st.divider()
