...
st.markdown("""
<style>
    /* Google Fonts Cairo for refined Arabic typography */
    ...
    /* Centered Platform Logo in Sidebar */
...
with st.sidebar:
    ...
    <div class="sidebar-header-card">
        ...
        <div class="platform-edition">
            ...
            المرجع الهندسي والرقابي الوطني 2026
        </div>
    </div>
    ...
    <div class="sidebar-cards-container">
        ...
        <div class="sidebar-feature-card">
            ...
            <div class="feature-body">
                ...
                <div class="feature-meta">
                    <span class="badge-tag tag-emerald">م.ب.ع 202</span>
                    <span class="feature-desc">الكود الإلزامي لتراخيص البناء</span>
                </div>
            </div>
        </div>

        <!-- 2. ADA Standards 2010 -->
        <div class="sidebar-feature-card">
            <div class="feature-icon-wrapper icon-blue">🇺🇸</div>
            <div class="feature-body">
                <div class="feature-name">المعايير الأمريكية للتصميم المتاح</div>
                <div class="feature-meta">
                    <span class="badge-tag tag-blue">ADA 2010</span>
                    <span class="feature-desc">المعايير القياسية العالمية</span>
                </div>
            </div>
        </div>

        <!-- 3. Simulation Lab & CAD -->
        <div class="sidebar-feature-card">
            <div class="feature-icon-wrapper icon-purple">🧪</div>
            <div class="feature-body">
                <div class="feature-name">مختبر المحاكاة الهندسية</div>
                <div class="feature-meta">
                    <span class="badge-tag tag-purple">7 محاكيات معمارية وتصدير CAD</span>
                </div>
            </div>
        </div>
        ...
        <div class="sidebar-feature-card">
            ...
            <div class="feature-body">
                ...
                <div class="feature-meta">
                    <span class="badge-tag tag-sky">18 محافظة</span>
                    <span class="feature-desc">مؤشرات امتثال جغرافية حية</span>
                </div>
            </div>
        </div>
        ...
        <div class="sidebar-feature-card">
            ...
            <div class="feature-body">
                ...
                <div class="feature-meta">
                    <span class="badge-tag tag-rose">AI Plan Checker</span>
                    <span class="feature-desc">فحص المساقط وتأشيرات Redlines</span>
                </div>
            </div>
        </div>
        ...
        <div class="sidebar-feature-card">
            ...
            <div class="feature-body">
                ...
                <div class="feature-meta">
                    <span class="badge-tag tag-amber">Empathy Mode</span>
                    <span class="feature-desc">عمى الألوان وضعف الرؤية</span>
                </div>
            </div>
        </div>

        <!-- 7. Citizen Voice & Reporting -->
        <div class="sidebar-feature-card">
            <div class="feature-icon-wrapper icon-teal">👥</div>
            <div class="feature-body">
                <div class="feature-name">منظومة صوت المواطن والتبليغ عن العوائق</div>
                <div class="feature-meta">
                    <span class="badge-tag tag-teal">بلاغات مجتمعية حية</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="sidebar-section-title" style="margin-top: 14px;">
        <div class="section-title-text">
            <span>📂</span>
            <span>تحميل الوثائق الهندسية الرسمية:</span>
        </div>
    ...
    st.markdown("""
    <div class="sidebar-partner-card">
